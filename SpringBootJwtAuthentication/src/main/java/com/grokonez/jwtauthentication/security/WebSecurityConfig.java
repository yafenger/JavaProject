...
//Authenciate authentication request with AuthenticationProvider
//by comparing the password submitted in a UsernamePasswordAuthenticationToken
// against the one loaded by the UserDetailsService (as a DAO)
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    //  permit users some resources with HTTPSecurity & Method Security Expressions
    @Override
